...
/* 
!imcomplete!
nn_network\data\Paypalipn\

DataPaypal Class for NN_Network Plugin
...
namespace nn_network\data\Paypalipn;

if ( ! defined( 'ABSPATH' ) ) { exit; }

if( !class_exists( 'NNDataPaypalipn' ) ){
	class NNDataPaypalipn{
