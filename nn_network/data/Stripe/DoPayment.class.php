<?php
/*
nn_network\data\Stripe\DoPayment

DoPayment - Data Class for NN_Network Class
...
if( !class_exists( 'DoPayment' ) ){
	...
	*/
		public function set_props(){
			...
			//Make Assignments. 
			$environ = ( defined( 'NN_DEV' ) && NN_DEV == true )? 'sandbox' : 'prod';
	...
	*/				
		public function handle_error( $error, $action ){
			...
			echo "The HANDLE ERROR method was called in the StripeDoPayment class";
		}
	}
