...
Services - Core Class Psuedo Code for NBCS Network Plugin
...
*/	
	...
	private function init( $data ){
		...
		$init_array = apply_filter( 'NNService_init', $init_array ); 
...
*/	
	...
	public function find(){
		...
		//$service = apply_filter( 'NNService_Find', $data );	
...
*/	
	...
	public function update_status( $status ){
		...
		if(  in_array( $status, $status_arr ) && !check_status( $status ) ){
			...
			do_action( "NNService_Update_{$uc_status}", $service_id );
...
*/	
	...
	public function build_title(){
		...
		//Service Name
		$serv_opts = get_option( 'NN_Services' );
